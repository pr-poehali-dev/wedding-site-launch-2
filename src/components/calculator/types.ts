...
export const ITEMS: Item[] = [
  ...
  { id: "menu", name: "Меню /1 чел.", icon: "UtensilsCrossed", defaultMin: 3500, defaultMax: 5000, category: "decor" },
  { id: "hall_rent", name: "Аренда зала", icon: "Building2", defaultMin: 15000, defaultMax: 15000, category: "decor" },
  { id: "tent_rent", name: "Аренда шатра", icon: "Tent", defaultMin: 20000, defaultMax: 30000, category: "decor" },
  { id: "outdoor_rent", name: "Аренда выездной", icon: "TreePine", defaultMin: 15000, defaultMax: 20000, category: "decor" },
  { id: "rislayker", name: "Рислейкер", icon: "Layers", defaultMin: 10000, defaultMax: 20000, category: "decor" },

  { id: "host", name: "Ведущий и DJ", icon: "Mic2", defaultMin: 30000, defaultMax: 70000, category: "entertainment" },
  ...
  { id: "artists", name: "Артисты 3 номера", icon: "Drama", defaultMin: 30000, defaultMax: 30000, category: "entertainment" },
  ...
  { id: "buffet", name: "Фуршет", icon: "GlassWater", defaultMin: 20000, defaultMax: 20000, category: "extra" },
